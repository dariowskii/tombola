...
class _GameSessionScreenState extends ConsumerState<GameSessionScreen> {
  ...
  void _shareGameLink() {
    ...
    try {
      var message = 'Guarda la mia cartella nella tombola di ML Modena! 🎉\n\n';
      message += 'ID sessione: ${widget.sessionId}\n';
      message += 'Username: ${raffleCard.username}\n\n';
      Share.share(message, subject: 'Cartella Tombola ML Modena');
    } catch (e) {
      if (mounted) {
